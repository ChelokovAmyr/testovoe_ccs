...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async loadData() {
        //вопрос, могу ли я немного изменить джейсон чтобы доделать остальное? там ничего сложного в 
        //остальном, просто возникли сложности с перекрестным джейсоном (перепробовал разные варианты)
        //насчет изменения данных и прочего сделаю через рест чтобы менять данные
        //окно с изменением данных и ви моделом сделаю через стор
      }
    },
    mounted() {
      this.loadData()
